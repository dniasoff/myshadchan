...
When asked about tasks, your agent will display an interactive widget with the list of tasks, allowing you to easily check them off, or navigate to the relevant contact Atomic CRM.

![Task list](../../images/mcp-app.png)
