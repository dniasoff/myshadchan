...
<video
    src="https://github.com/user-attachments/assets/2e5fa809-bd46-4ea1-926f-6f53358de681"
    controls
    className="w-full aspect-884/724"
></video>
...
- Deploying to Production
    ...
    - [Configuring Inbound Email](./developers/inbound-email-configuration) _(optional)_
