...
insert into results (name, passed)
-- Story 5.8 adds `resumes_single_id_fkey`, and the actor-scope migration adds
-- the three same-account shadchan attribution FKs on redts/shidduchim.  The
-- complete current set is therefore thirteen composite tenant joins.
