...
| E9d | State/theme/375px parity pass | 1 | none | PARTIAL | main (solo) | 3cdeaeb | session's NEW surfaces (Inbox, Billing, shadchan tiles, shidduch detail/catch) verified dark+mobile ✓; inbox label fixed. Full app-wide empty/loading/error+dark+AA sweep still owed |
| E9e | Inbox in mobile bottom nav | polish | none | TODO | — | — | E9d nit: Inbox is desktop-sidebar + direct-URL only on mobile; add to curated bottom nav / More |
